...
import { GoveeThermoHydrometerAccessory } from './platformAccessory';
 ...
 */
export class GoveeThermometerPlatform implements DynamicPlatformPlugin {
  ...
  async discoverDevices() {
    ...
    for (const device of devices) {
      ...
      if (existingAccessory) {
        ...
        new GoveeThermoHydrometerAccessory(this, existingAccessory);
        ...
        this.log.info('Created accessory');

        // store a copy of the device object in the `accessory.context`
        // the `context` property can be used to store any data about the accessory you may need
        accessory.context.device = device;
        this.log.info('Added context');

        // create the accessory handler for the newly create accessory
        // this is imported from `platformAccessory.ts`
        new GoveeThermoHydrometerAccessory(this, accessory);
